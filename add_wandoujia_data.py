...
def process():
    ...
    try:
        ...
        cur = conn.cursor()
        content = open('./data/wandoujia_game_data').read()
        ...
        for game in games:
            ...
            sqlcmd = "insert into wandoujia_data_new(title,key_tag,category,tag,description,download_num,like_num,comment_num,size,url) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) "
